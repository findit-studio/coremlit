...
// Relative to THIS package directory (`coremlit/tests/vad/swift`): five hops
// reach the directory holding the checkout, where the sibling clone lives.
// `regen_goldens.sh` normally overrides this with `FLUIDAUDIO_SRC`, which it
// resolves by SEARCHING for the workspace root; this literal is the
