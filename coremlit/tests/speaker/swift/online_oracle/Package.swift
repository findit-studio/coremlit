...
//
// The online-clusterer Swift ORACLE for `tests/speaker/parity_online_swift.rs`. Not
...
// (`coremlit/tests/speaker/swift/online_oracle`): six hops reach the directory
// holding the checkout, where the sibling clone lives. SwiftPM errors loudly
// on a path that does not resolve to a package.
