...
#   SIGLIP_GOLDENS     committed goldens dir (coremlit/tests/siglip/fixtures/goldens)
...
: "${SIGLIP_GOLDENS:?set SIGLIP_GOLDENS to coremlit/tests/siglip/fixtures/goldens}"
