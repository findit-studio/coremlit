...
#   GRANITE_GOLDENS     committed goldens dir (coremlit/tests/granite/fixtures/goldens)
...
: "${GRANITE_GOLDENS:?set GRANITE_GOLDENS to coremlit/tests/granite/fixtures/goldens}"
