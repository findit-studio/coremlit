...
/// `coremlit/tests/whisper_swift_probes/`. A host whose CoreVideo does
...
pub enum AlignmentGather {
  ...
  /// (`coremlit/tests/whisper/parity_jfk.rs`) pins both halves.
  ///
...
impl DecodingOptions {
  ...
  /// (`jfk_tiny_word_timestamps_match_swift_and_this_clip_is_gather_invariant`,
  /// `coremlit/tests/whisper/parity_jfk.rs`). Each of those tests pins
