...
//! list of [`WindowSpan`]s the [`AudioEncoder`](crate::AudioEncoder) embeds one
...
//! [`AggregatePolicy`](crate::aggregate::AggregatePolicy) can weight by time,
//! overlap, or coverage.
//!
...
use crate::{audio::TARGET_SAMPLES, embedding::Embedding};
...
/// preference. Equal to [`crate::audio::TARGET_SAMPLES`].
...
/// [`AudioEncoder::embed_windows`](crate::AudioEncoder::embed_windows) hands to
...
impl WindowSpan {
  ...
  /// coverage-aware [`AggregatePolicy`](crate::aggregate::AggregatePolicy) uses.
  #[inline]
...
/// the input unit to an [`AggregatePolicy`](crate::aggregate::AggregatePolicy).
///
