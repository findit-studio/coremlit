...
// `crates/speakerkit/tests/parity_online_swift.rs`.
//
...
// (`tests/parity_online_swift.rs`): the `Lcg`, `syntheticSequence`, and
...
// ── Generator constants (mirror tests/parity_online_swift.rs) ──
