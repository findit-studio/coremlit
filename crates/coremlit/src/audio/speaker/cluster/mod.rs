...
//!
//! [`crate::audio::speaker::extract::Extraction::diarize_with`] takes a [`ClusterBackend`] and
//! runs the named engine over an [`crate::audio::speaker::extract::Extraction`];
//! [`crate::audio::speaker::extract::Extraction::diarize`] is the same thing at the default
...
//!   [`crate::audio::speaker::extract::Extraction::diarize_online`]. `#[non_exhaustive]`
...
//! [`crate::audio::speaker::extract::Extraction::diarize`] relies on.
//!
...
/// same reason [`crate::audio::speaker::window`]'s `check_onset` is hand-rolled), so the check
...
/// four `f64` knobs make it unsound, exactly as [`crate::audio::speaker::window::WindowOptions`]
...
/// `[0.0, 2.0]`, and [`crate::audio::speaker::extract::Extraction::diarize_online`] takes NO
/// `plda` argument.
///
...
define_cluster_backend! {
  ...
  /// backend [`crate::audio::speaker::extract::Extraction::diarize_with`] runs. `#[non_exhaustive]`
  ...
  pub enum ClusterBackend {
    ...
    /// [`crate::audio::speaker::extract::Extraction::diarize_online`], or via
    /// [`diarize_with`](crate::audio::speaker::extract::Extraction::diarize_with) — which
...
impl Default for ClusterBackend {
  ...
  /// [`crate::audio::speaker::extract::Extraction::diarize`] uses.
  fn default() -> Self {
