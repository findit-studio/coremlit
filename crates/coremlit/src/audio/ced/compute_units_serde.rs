...
//! through its existing `as_str`/`FromStr` — the same shape the granite/clap
//! modules' private compute-units bridges use. Used by
//! [`crate::audio::ced::ClassifierOptions`] via
//! `serde(with = "crate::audio::ced::compute_units_serde")`.
