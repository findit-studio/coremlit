//! Shared serde bridge for [`crate::ComputeUnits`] (crate-private, `serde`
//! feature only).
//!
...
//! [`crate::embeddings::clap::audio::AudioEncoderOptions`] and [`crate::embeddings::clap::text::TextEncoderOptions`]
//! via `serde(with = "crate::embeddings::clap::compute_units_serde")`.
