...
# `crates/coremlit/tests/whisper/{parity_es,parity_jfk}.rs` (and, for its host
...
# ─────────────────────────────────────────────────────────────────────────────
#
#   Usage:  crates/coremlit/tests/whisper/swift/regen_goldens.sh
#
...
echo "  git diff -- crates/coremlit/tests/whisper/fixtures/golden/"
echo
